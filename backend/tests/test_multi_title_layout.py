...
from server import (
    clean_text,
    is_multi_title_pin_layout,
    parse_file,
    parse_font_size_px,
    parse_multi_title_pin_layout,
    read_tabular_file,
)


def test_parse_font_size_px_numeric_and_legacy():
    assert parse_font_size_px("", 12) == 12
    assert parse_font_size_px("  48 ", 12) == 48
    assert parse_font_size_px("large", 12) == 120
    assert parse_font_size_px("12px", 12) == 12
